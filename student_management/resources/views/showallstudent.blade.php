...
<table class="table" id='myTable'>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td> <img src="{{asset('uploaded_img')}}/{{{$c->img}}}" alt="" height='50' width='50'></td> 
            <td>{{$c->phone}}</td>
            <td>{{$c->Courses[0]->course_name}} </td> 
            <td>{{$c->Courses[0]->batch_time}} </td> 
            <td>{{$c->Courses[0]->teaching_day}} </td> 
